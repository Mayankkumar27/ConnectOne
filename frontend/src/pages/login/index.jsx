        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.cardContainer_left}>
            ...
            {!userLoginMethod && <div className={styles.inputRow}>
              ...
              <input onChange={(e)=> setEmailAddress(e.target.value)} className={styles.inputField} type="text" placeholder="Email ID" />
          ...
          <div onClick={() => {
            ...
            }style={{ color: "black", textAlign: "center", cursor: "pointer" }}className={styles.buttonWithOutline}>
