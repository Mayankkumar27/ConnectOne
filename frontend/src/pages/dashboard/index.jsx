...
//               <textarea onChange={(e) => setPostContent(e.target.value)}  value={postContent} placeholder='Write your Thoughts!' className={styles.textAreaOfContent} name='' id=''></textarea>
...
//                           <svg className="size-6" style={{ height: "1.4rem", color: "red" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
//                       </div>
//                       <p style={{fontWeight: "bold "}}>@{post.userId.username}</p>
      ...
      <DashboardLayout>
        <div className={styles.scrollComponent}>
          <div className={styles.wrapper}>
            ...
            <div className={styles.postsContainer}>
              {postState.posts.map((post) => (
                <div key={post._id} className={styles.singleCard_profileContainer}>
                  <img
                    className={styles.userProfile}
                  ...
                  <div>
                    ...
                    <div className={styles.optionsContainer}>
                      ...
                      <div onClick={async () => {
                        console.log("1. Clicked Like. Post ID:", post._id); 
                      ...
                      <div onClick={()=>{
                        ...
                        const url = encodeURIComponent("ConnectOne");
              ...
              className={styles.allCommentsContainer}>
                ...
                {postState.comments.length !== 0 && 
                  ...
                  {postState.comments.map((postComment, index) => {
                    return (
                      <div className={styles.singleComment} key={postComment.id}>
